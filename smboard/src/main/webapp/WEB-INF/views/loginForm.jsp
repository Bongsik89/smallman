...
<body>
	...
	<div class="container-fluid">
		<nav class="navbar naabar-default">
			<ul class="nav navbar-nav navbar-right">
				<li style="font-size: 16px"><a href="index">메인으로</a></li>
			</ul>
		</nav>
		<div class="naver-jeader">
			<a href="index"><img src="resources/img/smallGentleman.png" class="img-thumbnail" width="100px" height="100px"></a>
		</div>
	</div>
