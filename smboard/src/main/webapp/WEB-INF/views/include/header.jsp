...
<div class="container-fluid">
	<nav class="navbar navbar-default">
		<ul class="nav navbar-nav navbar-right">
			...
			<c:choose>
				...
				<c:otherwise>
					<li id="userImageLi">
						<img src="resources/img/123.jpg" class="img-circle" width="30px" height="30px">
					</li>
					<li>
	...
	<nav id="searchNav" class="col-sm-9 navbar navbar-default">
		<div class="navbar-header">
			<a href="/"><img src="resources/img/smallGentleman.png" class="img-thumbnail" width="100px" height="100px"></a>
		</div>
		<ul class="nav navbar-nav navbar-right">
			<li>
